#MODEL SELECTION
./hivm -p model-selection --probability 0 -d NFV -o results/NFV-CrossValb_short_t10 -t 10 -w ../../data/PI_wild.seq -f ../../data/PR_2006-05-25_v2.0.tsv --suscep-type clinical -x 0  -y 4 -z 2 -l -6 -m -2 -n 2
