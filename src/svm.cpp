	...
	double Cp, double Cn, double& probA, double& probB)
{
	...
	for(i=0;i<nr_fold;i++)
	{
		...
		subprob.x = Malloc(struct svm_node*,subprob.l);//memory leak
		subprob.y = Malloc(double,subprob.l);//memory leak
		...
		else
		{
			...
			//free(subprob.x);//Memory Leak fixed by Ed Johnson, 09/17/2006
			//free(subprob.y);//Memory Leak fixed by Ed Johnson, 09/17/2006
		}
