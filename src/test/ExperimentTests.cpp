...
#if defined  EXPERIMENTTESTS_TEST //Don't run with TEST_ALL
...
//	double best_lg_cost  =  6.5;//chosen from best cross val results 
//	double best_lg_gamma = -5.5;//chosen from best cross val result
//
//	ExperimentResult* er_best = new ExperimentResult(
//		best_lg_cost, best_lg_gamma
//		);
//
//	ve.run_experiment( 
//		f.input_train_set,
...
//	//double worst_lg_cost  = -3;//chosen from best cross val results 
//	//double worst_lg_gamma = -5;//chosen from best cross val result
//
//	//ExperimentResult* er_worst = new ExperimentResult(
//	//	worst_lg_cost, worst_lg_gamma
//	//	);
//
//	//ve.run_experiment( 
//	//	f.input_train_set,
...
//	//BOOST_CHECK_EQUAL( f.result_set.front()->lg_cost, 5 );
//	//BOOST_CHECK_EQUAL( f.result_set.front()->lg_gamma, -5 );
//	//BOOST_CHECK_EQUAL( f.result_set.back()->lg_cost, -3 );
//	//BOOST_CHECK_EQUAL( f.result_set.back()->lg_gamma, -5 );
//
...
//double lg_cost_low				=   5;
//double lg_cost_high			=   5;
//double lg_cost_inc		=  .5;
//
//double lg_gamma_low			=  -5;
//double lg_gamma_high			=  -5;
//double lg_gamma_inc		=  .5;
//
//
