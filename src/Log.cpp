...
std::string Log::elapsed_time()
{
	...
	int seconds_elapsed = (int)difftime (end_timer, start_timer);
	
	int seconds_in_hour = 3600;
	int seconds_in_minute = 60;

	int hours =     seconds_elapsed / seconds_in_hour;
	int minutes = ( seconds_elapsed % seconds_in_hour ) / seconds_in_minute;
	int seconds = ( seconds_elapsed % seconds_in_hour ) % seconds_in_minute;
