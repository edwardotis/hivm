...
//	predicting?
	...
	*/
	...
	@return accuracy as defined by hits/total_predictions
	*/
	void run_experiment( const PreProcWUSet& input, ExperimentResult* result, const Options& svm_param_options );
...
//private:
//void run_experiment_( const PreProcWUSet& input, ExperimentResult* result,  const Options& svm_param_options, double lg_cost, double lg_gamma );
