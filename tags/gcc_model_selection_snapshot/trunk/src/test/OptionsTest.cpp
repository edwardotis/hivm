...
//test: If I don't give a seed in cmd line, then should be set to -1 internally.
//BOOST_AUTO_TEST_CASE( OptionsTest_default_seed )
//{
//	int ac = 1;
//	char* av[ 1 ];
//	av[0] = "hivm";
//
//	Options options(ac, av);
//	BOOST_CHECK_EQUAL(options.seed, -1 );
//	
//}
