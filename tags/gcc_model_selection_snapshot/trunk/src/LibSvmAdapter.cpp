...
//	const double lg_cost_default = svm_param_options.lg_cost;// 
//	const double lg_gamma_default = svm_param_options.lg_gamma;//
//
//	return predict_susceptibility_( trainset, predictee, svm_param_options, lg_cost_default, lg_gamma_default  );
//}
...
//		trainset, predictee, svm_param_options, lg_cost_default, lg_gamma_default, probabilities_output  );
//}

//bool LibSvmAdapter::predict_susceptibility( const SvmWUMatrix& trainset, const SvmWUSet* predictee,
//										   const Options& svm_param_options, double lg_cost, double lg_gamma )
//{
//	return predict_susceptibility_( trainset, predictee, svm_param_options, lg_cost, lg_gamma  );
//}
...
//										  std::vector<double>& probabilities_output)
//{
//	return predict_susceptibility_with_probabilities_( trainset, predictee, svm_param_options, lg_cost, lg_gamma,
//		probabilities_output );
//}

//bool LibSvmAdapter::predict_susceptibility_( const SvmWUMatrix& trainset, const SvmWUSet* predictee, 
//											const Options& svm_param_options, const double lg_cost, const double lg_gamma )
//{
//	//train
...
//	//ALLOCATE MEMORY - DRY WARNING
//	struct svm_problem* problem = create_svm_problem( trainset );//NEW SVM_PROBLEM
//	struct svm_parameter* param = create_svm_parameter( problem, svm_param_options, lg_cost, lg_gamma );//NEW SVM_PARAMETER
//	struct svm_model* train_model = train( trainset, param, problem );//NEW SVM_MODEL
//
//	//predict
	...
	const Options& svm_param_options, ExperimentResult* result )
{
	...
	//return predict_susceptibility_many_( trainset, predictees, svm_param_options  );
	...
	for( int i=0; i < predictees.size(); i++ )
	{
		...
		else//straight prediction with no probability information
		{
...
//	const double lg_gamma_default = svm_param_options.lg_gamma;
//
//	return predict_susceptibility_many_( trainset, predictees, svm_param_options, lg_cost_default, lg_gamma_default  );
//	
//}
...
//														const Options& svm_param_options, double lg_cost, double lg_gamma )
//{
//	return predict_susceptibility_many_( trainset, predictees, svm_param_options, lg_cost, lg_gamma  );
//}
...
//				const Options&, const double lg_cost, const double lg_gamma, std::vector<double> probabilities_output )
//{
//	//train
//	//ALLOCATE MEMORY - DRY WARNING
//	struct svm_problem* problem = create_svm_problem( trainset );//NEW SVM_PROBLEM
