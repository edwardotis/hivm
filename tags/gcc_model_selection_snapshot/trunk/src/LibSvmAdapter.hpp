...
public:
	...
	*/
	...
	//std::vector<bool>  predict_susceptibility_with_probabilities( const SvmWUMatrix& trainset, const SvmWUMatrix& predictees,
	//	const Options& svm_param_options, double lg_cost, double lg_gamma, std::vector<double> probabilities_output );
...
//private:
	...
	//										const Options&, const double lg_cost, const double lg_gamma,
	//										std::vector<double> probabilities_output );
