...
//#define PREPROCWORKUNIT_TEST // file has ExperimentResultTest
#define EXPERIMENTRESULT_TEST
#define CROSSVALIDATIONEXPERIMENTTEST_TEST// file has VALIDATIONEXPERIMENTTEST_TEST
