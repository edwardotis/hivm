...
public:
	...
	void cross_validate( Options& options );//param search and crossval on train data
	void self_validate(  Options& options );//param search and full selftest on train data
