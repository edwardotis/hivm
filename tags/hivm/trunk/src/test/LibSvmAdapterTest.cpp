...
BOOST_AUTO_TEST_CASE( LibSvmAdapterTest_create_svm_parameter )
{
	...
	struct svm_parameter* param2 = l.create_svm_parameter( problem, o, 3, -3  );
	...
	struct svm_parameter* param3 = l.create_svm_parameter( problem, o, 32, -31  );
	...
	struct svm_parameter* param4 = l.create_svm_parameter( problem, o, 33, -32  );
	...
	struct svm_parameter* param5 = l.create_svm_parameter( problem, o, 0, -1  );
...
BOOST_AUTO_TEST_CASE( LibSvmAdapterTest_predict_susceptibility_pr_small3 )
{
	...
	//TODO make something more useful out of this?
	bool result;
	result = l.predict_susceptibility( f.svm_train_matrix, f.svm_predictee_matrix[0], o );
	result = l.predict_susceptibility( f.svm_train_matrix, f.svm_predictee_matrix[1], o );
}
...
BOOST_AUTO_TEST_CASE( LibSvmAdapterTest_predict_susceptibility_vs_libsvm_predict )
{
	...
	if( svm_result == -1 )
	{
		...
		BOOST_CHECK_EQUAL( is_libsvm_susceptible, l.predict_susceptibility( f.svm_train_matrix, f.svm_predictee_matrix[0], o ) );
	}
